              ...
              <ul>
                ...
                <li className="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link to="/studentdetails">Student View</Link>
                    </li>
                    <li>
                      <Link to="/addstudents">Student Add</Link>
                    </li>
                    <li>
                      <Link to="/editstudents">Student Edit</Link>
                    </li>
                  </ul>
                </li>
                <li className="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link to="/teacherdetails">Teacher View</Link>
                    </li>
                    <li>
                      <Link to="/addteacher">Teacher Add</Link>
                    </li>
                    <li>
                      <Link to="/Editteacher">Teacher Edit</Link>
                    </li>
                  </ul>
                </li>
                <li className="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link to="/adddepartment">Department Add</Link>
                    </li>
                    <li>
                      <Link to="/Editdepartments">Department Edit</Link>
                    </li>
                  </ul>
                </li>
                <li className="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link to="/editsubject">Subject Edit</Link>
                    </li>
                  </ul>
                </li>
                <li className="menu-title">
                ...
                <li className="submenu">
                  ...
                  <ul>
                    <li>
                      <Link to="/Feescollection">Fees Collection</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/addfeescollection">Add Fees</Link>
                    </li>
                    <li>
                ...
                <li className="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link to="/Page404">Error Page</Link>
                    </li>
                  </ul>
                </li>
                <li>
