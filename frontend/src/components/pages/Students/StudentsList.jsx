...
const Students = () => {
    ...
    const getUserData = ((studentId)=>{
        return studentsData.filter((std)=> std.StudentId === studentId)
    })
    const dataToSend = {name: "Mohannad", age: "23"};
            ...
            render: (text, record) => (
                <>
                    <h2 className="table-avatar">
                        <Link to={{
                            pathname: "/studentsview",
                            state: dataToSend //Object
