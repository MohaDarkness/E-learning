                ...
                <ul className="list-group">
                  {syllabusFiles.map((file, index) => (
                    <li key={index} className="list-group-item d-flex align-items-center  border-0">
                        {file.type === 'pdf' && <i className="fas fa-file-pdf"></i>}
                      <a className='ms-2' href={`https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf`} download>{file.name}</a>
              ...
              <div className="card-body">
                ...
                <ul className="list-group">
                  {otherFiles.map((file, index) => (
                    <li key={index} className="list-group-item d-flex align-items-center  border-0">
                    {file.type === 'pdf' && <i className="fas fa-file-pdf mr-2"></i>}
                  <a className='ms-2' href={`https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf`} download>{file.name}</a>
          ...
          <Modal.Body>
            <Form onSubmit={handleSubmit}>
              <Form.Group className="mb-3" controlId="section">
                ...
                <Form.Control as="select" name="section" value={formData.section} onChange={handleChange}>
              ...
              <Form.Group className="mb-3" controlId="data">
                ...
                <Form.Control type="text" placeholder="Enter Text" name="data" value={formData.data} onChange={handleChange} />
              </Form.Group>
